...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_base_aloha_lora_randomized_multimodal_50x10",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAlohaDataConfig(
            repo_id="NatashaYang/robotwin_demo_randomized_multimodal_50x10_lerobot",
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    "images": {
    ...
    TrainConfig(
        name="pi05_base_aloha_lora_clean_50x25",
        model=pi0_config.Pi0Config(pi05=True, paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAlohaDataConfig(
        ...
        fsdp_devices=1,
        ema_decay=None,
        episodes_per_task=25,  # select 10 episodes per RoboTwin task (not per instruction)
    ),
    TrainConfig(
